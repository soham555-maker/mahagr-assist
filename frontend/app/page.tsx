...
import { AbstentionBanner, EmptyHint, LangToggle, SourceCard, Spinner, isAbstention } from "@/components/ui";
...
export default function ChatPage() {
  ...
  return (
    <main className="mx-auto flex min-h-[calc(100dvh-56px)] max-w-3xl flex-col px-4">
        ...
        <div className="mb-2 flex items-center justify-between">
          ...
          {messages.length > 0 && (
            <button
              type="button"
              onClick={() => setMessages([])}
              className="cursor-pointer text-xs text-slate2 hover:text-ink"
            >
              Clear conversation
            </button>
          )}
